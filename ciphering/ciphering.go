...
func NewEncryptClosure(input io.Reader, output io.Writer) func(key []byte) (err error) {
...
func NewDecryptClosure(input io.Reader, output io.Writer) func(key []byte) (err error) {
	return func(key []byte) (err error) {
